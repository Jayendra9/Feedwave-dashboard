          ...
          <Card className="max-w-[350px] flex flex-col h-full bg-gray-300">
            <CardHeader className="flex-1">
              <CardTitle className="flex flex-row text-sm md:text-lg items-center">
                ...
                <span>Project Limit Reached</span></CardTitle>
              <CardDescription className="mt-3">You&apos;ve reached the max number of projects for now. Keep going strong with the ones you have! <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="inline h-5 w-5 ml-1">
